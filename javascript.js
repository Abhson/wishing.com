...
var image1 = document.querySelectorAll("img")[0].setAttribute("src", "adimage"+randomNumber1+".jpg");
...
/*
Setting up the sharing button to share current page on social platform
*/
...
function init(){
  ...
  let postTitle= encodeURI("Hey I am abhson...");
